    ...
    <div>
        <div className={styles["pagecontent"]}>
            ...
            <div className={styles["addfriendbox"]}>
                <div className={styles["alreadysent"]}>
                    Friend request was already sent. Please wait for the person's response.
                </div>
...
export default FriendAlreadyAdded