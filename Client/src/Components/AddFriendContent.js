        ...
        <div className={styles["pagecontent"]}>
            ...
            <div className={styles["addfriendbox"]}>
                ...
                <div className={styles["notetext"]}>
                    <label className={styles["text"]}>Note: Username is case-sensitive.</label>
                    <label className={styles["text"]}>Do not worry about duplicate usernames, they are all unique!</label>
                </div>
            </div>
        </div>
