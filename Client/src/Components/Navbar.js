...
const Navbar = () => {
  ...
  return (
    <div className={styles["navbar"]}>
        ...
        <form className={styles["search"]} action={'/search-friend'} method={"POST"}>
          <input className={styles["searchinput"]} type="search" placeholder="Search for player..." id="username" name="username"></input>
